    ...
    <div className="min-h-screen bg-gray-50 text-gray-900">
          ...
          <div className="bg-white rounded-2xl p-8 max-w-md w-full shadow-lg relative">
            ...
            <div className="grid grid-cols-2 gap-6 mb-8">
              ...
              >
                ...
                <p className="text-sm text-center text-gray-600">
                  Curated series of guides in order.
                </p>
              </div>
            </div>
            ...
            <p className="text-center text-base font-semibold">
              {searchMode === "smart"
                ...
                : "Search by name, location or tag"}
            </p>
          </div>
        </div>
      )}
      ...
      >
        <div className="max-w-3xl text-center">
          ...
          <p className="text-gray-700 text-lg mb-4">
            Our audio guides deliver focused, easy-to-digest insights that help
